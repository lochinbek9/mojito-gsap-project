...
function Menu() {
    ...
    useGSAP(() =>{
        gsap.fromTo('#title', {opacity: 0}, {opacity: 1, duration: 1}, [currentIndex]);
    ...
    return (
        <section id="menu" aria-labelledby="menu-heading">
            <img src="../public/images/slider-left-leaf.png" alt="slider left" id="m-left-leaf" />
            <img src="../public/images/slider-right-leaf.png" alt="slider right" id="m-right-leaf" />
